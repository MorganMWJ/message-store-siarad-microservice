...
asadmin create-jdbc-connection-pool --datasourceclassname org.postgresql.ds.PGConnectionPoolDataSource
			...
			--property User=admin:PortNumber:5100:Password=admin:ServerName=localhost:DatabaseName=message_store
      message_store_db_pool

asadmin create-jdbc-resource --connectionpoolid message_store_db_pool jdbc/message_store
